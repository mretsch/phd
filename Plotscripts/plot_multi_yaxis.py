...
var1 = xr.open_dataarray(home+'/Google Drive File Stream/My Drive/Data_Analysis/rom.nc')# .percentile * 100 # .sel({'time':slice('2009-11-30','2009-12-02')})
var2 = xr.open_dataarray(home+'/Google Drive File Stream/My Drive/Data_Analysis/conv_intensity.nc')#.sel({'time':slice('2009-11-30','2009-12-02')})
var3 = xr.open_dataarray(home+'/Google Drive File Stream/My Drive/Data_Analysis/conv_rr_mean.nc')#.sel({'time':slice('2009-11-30','2009-12-02')})  # * 100
...
p0, = ax_host.plot(var_day[0].time, var_day[0], "k",           lw=2, label="ROM", alpha=0.)
...
p3, =   ax_r3.plot(var_day[0].time, var_day[0], "k",           lw=2, label="ROM")
