...
metric_1 = xr.open_dataarray('/Users/mret0001/Data/Analysis/No_Boundary/moo.nc')  # eso_random.nc')
metric_2 = xr.open_dataarray('/Users/mret0001/Data/Analysis/No_Boundary/sic.nc')  # sic_random.nc')
metric_3 = metric_2  # xr.open_dataarray('/Users/mret0001/Data/Analysis/No_Boundary/cop.nc')
ds_steiner = xr.open_mfdataset('/Users/mret0001/Data/Steiner/*season1213*', chunks=40)  # STEINER_random_scenes_noBound.nc')
...
consecutive = True
if consecutive:
    start_date = '2013-03-16T09:00:00'  # '2009-12-07T09:10:00'  #  '2015-11-10T03:00:00'
    end_date   = '2013-03-16T12:10:00'  # '2009-12-07T12:20:00'  #  '2015-11-10T06:10:00'
