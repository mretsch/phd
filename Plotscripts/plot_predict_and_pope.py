...
model_path = '/Documents/Data/NN_Models/ROME_Models/Kitchen_WithoutFirst10/'
...
for i, ax in enumerate(axes):
    ax.plot(rome             [plot_index], color='white', lw=3)
    # ax.plot(area             [-n_last:], color='red'  , lw=1.5)
    ax.plot(predicted_list[i][plot_index], color='black', lw=1.5)
