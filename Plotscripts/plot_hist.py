...
if __name__ == '__main__':
    ...
    if hist_2d:
        ...
        # var2 = ls.RH.sel(lev=515)#lw_net_toa#PW#h2o_adv_col
        ...
        fig_h_2d, h_2d = histogram_2d(var1, var2,  nbins=75,#23,
                                      x_label= 'ROME',#var1.long_name+' ['+var1.units+']', #'Total conv. area [km$^2$]', #
                                      y_label= 'R_NN',#var2.long_name+' ['+var2.units+']', # 'Number of objects [1]', #
